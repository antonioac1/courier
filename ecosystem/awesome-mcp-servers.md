...
- **Context for LLMs**: [/llms.txt](https://getcourier.dev/llms.txt)
- **OpenAPI**: [/openapi.json](https://getcourier.dev/openapi.json)
- **License**: MIT
- **Tags**: `messaging`, `queues`, `agent-communication`, `continuity`, `self-hosted`
